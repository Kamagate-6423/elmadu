<?php
session_start();
if((isset($_POST['tel'])) || (isset($_POST['passe1']) && isset($_POST['passe2']) && isset($_POST['passe3']) && isset($_POST['tel1']))){
	...
	<?php function connecter(){?>
			...
			<form method="post" action="../controller/requeteClients.php?connexion=connexion" role="form" class="connexion">
				<fieldset class="field"><legend>Connexion</legend>
					...
					<table style="margin-top:20px; width:100%;">
						<tr>
							<td colspan="2"><a href="#" class="connexion1"><input type="submit" value="Confirmer"  class="connexion btn btn-success" style="margin-left:50%"></a></td>
						</tr>
					</table>
				</fieldset>	
			</form>
			...
			<div class="form">
			<button type="button "class="btn ouvrePassOublier" style="font-weight:bold; color:#000">Mot de passe oublier</button>
				...
				<div style="text-align:center">Remplir ces champs pour la rénitialisation de votre mot de passe</div>
					<table>
						<tr>
							...
							<td><input type="tel" id="nom" name="nom"  maxlength="20" required><br/><span class="help-inline tel"></span></td>
						</tr>
						<tr>
							<td> <label for="prenom"> Prenom</label></td>
							<td><input type="tel" id="prenom" name="prenom" maxlength="20" required><br/><span class="help-inline tel"></span></td>
						</tr>
						<tr>
					...
					<table style="margin-top:20px; width:100%;">
						<tr>
							<td colspan="2"><a href="#" class="passOublier"><input type="submit" value="Confirmer"  class="passOublier btn btn-success" style="margin-left:50%"></a></td>
						</tr>
					</table>
				</fieldset>	
			</form>
				...
				<fieldset class="field"><legend>Inscription</legend>
					<table cellspacing="20">
						...
						<tr>
							...
							<td><span class="passDifferent" id="passCliDifferent"> Les deux passes ne sont pas identiques</span> <label for="passCl">Mot de passe<span style="color:red; font-size:16px"> *</span></label> </td>
							<td><input type="password" id="passCli" name="passCli" maxlength="16" required class="pass1"><br/><span class="passCli"></span></td>
						</tr>
						<tr>
							<td><label for="passCliConf">Remettre le mot de passe<span style="color:red; font-size:16px"> *</span></label> </td><td><input type="password" id="passCliConf" name="passCliConf" maxlength="20" required class="pass2"><br/><span class="pass2Cli"></span></td>
						</tr>
						<tr>
					...
					<table style="margin-top:20px; width:100%;">
						<tr>
							<td colspan="2"><input type="submit" value="Confirmer" class="btn btn-success inscrireSubmit" style="margin-left:50%" /></td>
						</tr>
					</table>
				</fieldset>	
			</form>
